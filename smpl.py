...
def wa1():
	try:
		...
		for i in range(int(jum)):
			...
			ol2=json.dumps({"name":"AmmarExecuted","email":"ganzpaling@gmail.com","password":"@mm4rgans","phone":"+62"+nomor,"phone_format":nomor,"name_toko":"","url_id":"","business_type_id":"","service_type_id":3,"country_id":"ID","city_id":"","state_id":"","pos_resto_mode":0,"i_agree":"true","address":"","id":"null","tokenMiscall":"","use_otp_type":3})
...
def cal1():
	try:
		...
		for i in range(int(jum)):
			...
			dat=json.dumps({"name":"AmmarExecuted","email":"tololbet615@gmail.com","password":"@mm4rgans","phone":"+62"+nomor,"phone_format":nomor,"name_toko":"","url_id":"","business_type_id":"","service_type_id":3,"country_id":"ID","city_id":"","state_id":"","pos_resto_mode":0,"i_agree":"true","address":"","id":"null","tokenMiscall":"","use_otp_type":2})
